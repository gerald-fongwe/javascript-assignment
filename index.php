				...
				<div class="col-md-12">
					<div id="mouse" onmouseover="mouseOver()" onmouseout="mouseOut()">
						<p>
							...
							short ribs leberkas kielbasa, pork short loin frankfurter pig boudin biltong t-bone. Boudin rump
							venison tongue andouille pancetta short loin sirloin alcatra tri-tip pork short ribs capicola. Beef
					...
					<div class="row">
						<div class="col-md-12">
							...
							<p>
								...
								chuck, ham hock corned beef shank pancetta meatloaf short loin flank. Chuck tongue boudin, pork
								belly chicken porchetta hamburger owl ham hock doner rump salami picanha turkey pig. Swine
